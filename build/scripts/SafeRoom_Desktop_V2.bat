...
@rem ##########################################################################
@rem
@rem  SafeRoom_Desktop_V2 startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and SAFE_ROOM_DESKTOP_V2_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAFE_ROOM_DESKTOP_V2_OPTS%  -classpath "%CLASSPATH%" com.saferoom.MainApp %*
...
:fail
rem Set variable SAFE_ROOM_DESKTOP_V2_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%SAFE_ROOM_DESKTOP_V2_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
